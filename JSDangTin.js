...
$("#upload_room_button").click(function () {
	...
	var checkboxveSinh = document.getElementsByName("VeSinh");
	var veSinhChecked = false;
	for (var i = 0; i < checkboxveSinh.length; i++) {
		if (checkboxveSinh[i].checked === true) {
			veSinhChecked = true;
		}
	}
	if (veSinhChecked === false) {
